    ...
    <div className="min-h-screen bg-white px-4 pb-20 md:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {user ? (
          ...
          // Anonymous users: Show lock screen
          <div className="bg-gradient-to-r from-red-50 to-orange-50 border border-red-200 rounded-lg p-8 text-center">
            <div className="max-w-md mx-auto space-y-4">
              ...
              <p className="text-gray-600">
                Create a free account to access unlimited safety insights, detailed metrics, community discussions, and contribute your own experiences.
              </p>
