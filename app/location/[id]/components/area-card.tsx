    ...
    <Card className="w-full bg-white border border-white/10" >
      ...
      <CardContent className="pt-0 flex flex-col lg:flex-row w-full justify-between gap-4 lg:gap-0">
        <div className="flex justify-between items-start w-full lg:w-auto">
          ...
          {/* Follow button - visible on mobile only */}
        ...
        <div className="flex flex-col gap-4">
          {/* Follow button - visible on desktop only */}
          <div className="hidden lg:block">
            <Follow id={id} following={data?.isFollowing ?? false} />
          </div>
          <div className="flex flex-row justify-between px-8 lg:items-center gap-4 sm:gap-6 mt-4 md:mt-0">
